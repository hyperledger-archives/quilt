...
public class AsnInterledgerRejectPacketData extends AsnSequence<InterledgerRejectPacket> {

  public AsnInterledgerRejectPacketData() {
    super(
        new AsnInterledgerErrorCode(),
        new AsnInterledgerAddress(),
        new AsnUTF8String(new AsnSizeConstraint(0, 8192)),
