...
public class AsnInterledgerPreparePacket extends AsnSequence<InterledgerPreparePacket> {

  public AsnInterledgerPreparePacket() {
    super(
        new AsnUint64(),
        new AsnTimestamp(),
        new AsnCondition(),
        new AsnInterledgerAddress(),
        new AsnOctetString(new AsnSizeConstraint(0, 32767))  //TODO Implement max getLength
    );
  }
