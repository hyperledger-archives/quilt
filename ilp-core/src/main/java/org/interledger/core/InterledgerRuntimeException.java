...
public class InterledgerRuntimeException extends RuntimeException {
   ...
   */
  public InterledgerRuntimeException(String message) {
    super(message);
  }
   ...
   *                unknown.)
   */
  public InterledgerRuntimeException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *              unknown.)
   */
  public InterledgerRuntimeException(Throwable cause) {
    super(cause);
  }
   ...
   *                           be writable
   */
  protected InterledgerRuntimeException(String message, Throwable cause, boolean enableSuppression,
