...
public abstract class AbstractFactoryTest extends AbstractCryptoConditionTest {
  ...
  public void setup() {
    ...
    this.subcondition1 = subfulfillment1.getCondition();
    ...
    this.subcondition4 = subfulfillment4.getCondition();
    ...
    this.subcondition5 = subfulfillment5.getCondition();
  }
}