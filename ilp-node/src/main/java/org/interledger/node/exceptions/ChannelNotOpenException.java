...
public class ChannelNotOpenException extends ChannelException {
   ...
   */
  public ChannelNotOpenException(Channel plugin) {
    super(plugin);
  }
   ...
   */
  public ChannelNotOpenException(String message, Channel plugin) {
   ...
   * @since 1.4
   */
  public ChannelNotOpenException(String message, Throwable cause,
                                 Channel plugin) {
   ...
   * @since 1.4
   */
  public ChannelNotOpenException(Throwable cause,
                                 Channel plugin) {
    super(cause, plugin);
  }
