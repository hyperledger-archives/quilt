...
public class RequestRejectedException extends Exception {
  ...
  private final InterledgerRejectPacket rejectMessage;

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public RequestRejectedException(InterledgerRejectPacket rejectMessage) {
    super();
   ...
   * @since 1.7
   */
  public RequestRejectedException(String message, Throwable cause, boolean enableSuppression,
