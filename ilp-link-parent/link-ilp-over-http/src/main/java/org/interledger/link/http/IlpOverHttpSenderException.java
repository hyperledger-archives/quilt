...
/**
 * Thrown by instances of {@link HttpSender}.
 */
public class IlpOverHttpSenderException extends RuntimeException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not initialized, and may
   * subsequently be initialized by a call to {@link #initCause}.
   */
  public IlpOverHttpSenderException() {
    super();
  }
   ...
   *                method.
   */
  public IlpOverHttpSenderException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public IlpOverHttpSenderException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public IlpOverHttpSenderException(Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.7
   */
  protected IlpOverHttpSenderException(String message, Throwable cause, boolean enableSuppression,
