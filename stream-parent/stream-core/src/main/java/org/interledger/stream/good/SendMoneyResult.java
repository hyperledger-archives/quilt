 ...
 */
// TODO: Compare with original result. Are they different?
@Immutable
public interface SendMoneyResult {
  ...
  /**
   * The original request to send money.
   *
   * @return A {@link SendMoneyRequest}.
   */
   ...
   */
  UnsignedLong amountDeliveredToReceiver();
   ...
   */
  UnsignedLong amountSentBySender();
