...
public class ConnectionManager {
   ...
   *
   * @return A {@link ConnectionDetails}.
   */
  ...
  /**
   * <p>Allows either endpoint to close a stream using a {@link StreamCloseFrame} frame. Implementations MAY allow
   * half-open streams (where one side has closed and the other is still able to send).</p>
   *
