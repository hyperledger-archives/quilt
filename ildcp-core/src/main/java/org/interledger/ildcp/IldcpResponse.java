...
public interface IldcpResponse {
  ...
  /**
   * The Interledger address of the account assigned by the configuration provider (i.e., the
   * address this ILDCP client should use).
   *
   ...
   * account's base units. More formally, an integer (..., -2, -1, 0, 1, 2, ...), such that one of
   * the account's base units equals 10^-<tt>currencyScale</tt> <tt>currencyCode</tt></p>
   *
