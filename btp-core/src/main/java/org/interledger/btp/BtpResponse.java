...
/**
 * Returned from a peer if the peer acknowledges a {@link BtpMessage} or {@link BtpTransfer}. If the
 * peer has data to send in reply (e.g. a quote response), it is carried in the protocol data of
 * this response. In addition, if a Response has been returned for a {@link BtpTransfer}, balances
