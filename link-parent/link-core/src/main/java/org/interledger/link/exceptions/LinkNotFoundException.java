...
public class LinkNotFoundException extends LinkException {
   ...
   * @param linkId  The {@link LinkId} that triggered this exception.
   */
  public LinkNotFoundException(String message, LinkId linkId) {
   ...
   * @param linkId  The {@link LinkId} that triggered this exception.
   */
  public LinkNotFoundException(String message, Throwable cause, LinkId linkId) {
   ...
   * @param linkId The {@link LinkId} that triggered this exception.
   */
  public LinkNotFoundException(Throwable cause, LinkId linkId) {
    super(cause, linkId);
  }
   ...
   * @param linkId             The {@link LinkId} that triggered this exception.
   */
  public LinkNotFoundException(String message, Throwable cause, boolean enableSuppression,
